...
def save_maps(map_dict, prefix_path, FDFheader):
    ...
    unit_dict = {
        ...
        "dFDFrms": flux_unit,
        "phiPeakPIchan_rm2": "rad/m^2",
        "dPhiPeakPIchan_rm2": "rad/m^2",
        "ampPeakPIchan": flux_unit,
        "ampPeakPIchanEff": flux_unit,
        "dAmpPeakPIchan": flux_unit,
        "snrPIchan": "",
        "indxPeakPIchan": "",
        "peakFDFimagChan": flux_unit,
        "peakFDFrealChan": flux_unit,
        "polAngleChan_deg": "deg",
        "dPolAngleChan_deg": "deg",
        "polAngle0Chan_deg": "deg",
        "dPolAngle0Chan_deg": "deg",
